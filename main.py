...
cpimg = "https://telegra.ph/file/0ce5dbbf938910d17daed-0a3bd9607bb0f12fbe.jpg"  
...
OWNER_ID = 8036182138 # Replace with the actual owner's user ID

# List of sudo users (initially empty or pre-populated)
SUDO_USERS = [7206113929]

AUTH_CHANNEL = -1002635928622
...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ🇮🇳" ,url=f"https://t.me/IFSASHU1BOT") ],
                    [
                    InlineKeyboardButton("🔔ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ🔔" ,url="https://t.me/IFSASHU1") ],
                    [
                    InlineKeyboardButton("🦋ғᴏʟʟᴏᴡ ᴜs🦋" ,url="https://t.me/IFSASHU1")                              
                ],           
            ]
      )
...
async def help_command(client: Client, msg: Message):
    help_text = (
        "`/start` - Start the bot⚡\n\n"
        "`/ashu` - Download and upload files (sudo)🎬\n\n"
